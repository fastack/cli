...
vorpal
<<<<<<< 47cde4dea991e437190686840fbfecbc6e0126b7
...
vorpal
	.command('rm <file-to-rm>', 'remove a file from directory')
...
vorpal
	...
	.action(function(args, callback) {
		console.log(highlight(fs.readFileSync(Path.resolve(FASTACK.cwd, args.file), 'utf8'), {
