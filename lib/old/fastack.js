...
program
  .command('build')
  .description('package your application')
  .action(function() {
...
program
    .command('register')
    .description('create a Fastack user account')
    .action(function() {
      prompt.start();
...
program
    .command('login')
    .description('authenticate a Fastack user account')
    .action(function() {
      prompt.start();
